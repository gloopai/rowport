...
RowPort 的核心目标是做一个轻量、清晰、可信任的桌面 MySQL 客户端，覆盖开发者和小团队最频繁的数据库日常操作：
...
> RowPort 是一个开源、轻量、以 MySQL 日常操作为中心的本地桌面数据库客户端。
...
- [ ] P1 引入语法高亮 SQL 编辑器。
- [ ] P1 改进 SQL 格式化。
- [ ] P1 支持执行当前语句、选区、全部语句三种模式。
- [ ] P1 查询历史按 profile/database 分组。
- [ ] P1 查询历史支持搜索。
- [ ] P1 支持收藏 SQL。
- [ ] P1 支持保存 snippet。
- [ ] P1 支持保存当前 SQL 到文件。
