...
function isSelected(type) {
  return (
    props.currentTab?.profileId === props.profileId &&
...
<template>
  <div class="tree-children table-objects">
    <button class="tree-row object-folder" :class="{selected: isSelected('columns')}" @click="selectObject('columns')">
    ...
    <div v-if="isExpanded('columns', profileId, databaseName, tableName)" class="tree-children leaf-list">
      <button v-for="column in columns()" :key="column.name" class="tree-row leaf-row" @click="selectObject('columns')">
    ...
    <button class="tree-row object-folder" :class="{selected: isSelected('keys')}" @click="selectObject('keys')">
    ...
    <div v-if="isExpanded('keys', profileId, databaseName, tableName)" class="tree-children leaf-list">
      <button v-for="column in primaryColumns()" :key="column.name" class="tree-row leaf-row" @click="selectObject('keys')">
    ...
    <button class="tree-row object-folder" :class="{selected: isSelected('indexes')}" @click="selectObject('indexes')">
    ...
    <div v-if="isExpanded('indexes', profileId, databaseName, tableName)" class="tree-children leaf-list">
      <button v-for="index in indexes()" :key="`${index.indexName}.${index.seqInIndex}`" class="tree-row leaf-row" @click="selectObject('indexes')">
    ...
    <button class="tree-row object-folder" :class="{selected: isSelected('ddl')}" @click="selectObject('ddl')">
